...
use League\HTMLToMarkdown\Converter\VideoEmbedConverter;
use League\HTMLToMarkdown\Converter\IFrameConverter;
...
final class Environment
{
    ...
    public static function createDefaultEnvironment(array $config = array())
    {
        ...
        $environment->addConverter(new VideoEmbedConverter());
